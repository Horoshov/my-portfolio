...
const howIWorkSteps = [
  {
    category: 'Discovery',
    duration: '1-2 недели',
    title: 'Глубокое погружение в ваши цели и долгосрочное видение.',
  ...
  },
  {
    category: 'Design',
    duration: '2-3 недели',
    title: 'Создание чистых и эффективных макетов для современных брендов.',
  ...
  },
  {
    category: 'Build',
    duration: '1-3 недели',
    title: 'Разработка сайтов с использованием мощных no-code инструментов.',
  ...
  },
  {
    category: 'Launch',
    duration: '1-2 недели',
    title: 'Запуск продукта, оптимизированного для реальных результатов.',
