...
const SKILL_ICONS = {
  ...
  "Jira": (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M38.2498 24.497H20.1914C20.1942 28.9951 23.8398 32.6408 28.338 32.6438H31.6646V35.8659C31.6703 40.364 35.3184 44.0072 39.8165 44.0072V26.0639C39.8165 25.1986 39.115 24.497Z" fill="#0052CC"/>
      <path d="M29.3085 33.4898H11.25C11.25 37.992 14.8999 41.6417 19.4019 41.6417H22.7389V44.8534C22.7418 49.3474 26.3811 52.9915 30.8752 53V35.0565C30.8752 34.1913 30.1737 33.4898 29.3085 33.4898Z" fill="#2684FF"/>
    </svg>
  ),
  "React": (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="32.5" cy="32" rx="20.5" ry="8" stroke="#0DACF1" strokeWidth="1"/>
      <ellipse cx="32.5" cy="32" rx="20.5" ry="8" stroke="#0DACF1" strokeWidth="1" transform="rotate(60 32.5 32)"/>
      <ellipse cx="32.5" cy="32" rx="20.5" ry="8" stroke="#0DACF1" strokeWidth="1" transform="rotate(-60 32.5 32)"/>
    </svg>
  ),
  "Miro": (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="64" height="64" rx="16" fill="#000"/>
      <path d="M41.3415 14H36.0731L40.4633 21.7136L30.8048 14H25.5367L30.3659 23.428L20.2683 14H15L20.2683 26.0008L15 50H20.2683L30.3659 24.2864L25.5367 50H30.8048L40.4633 22.572L36.0731 50H41.3415L51 19.9993L41.3415 14Z" fill="white"/>
    </svg>
  ),
  "Git": (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const SkillItem = ({ skill }) => {
  ...
  return (
    <div className="skill-item" ref={ref}>
      <div className="skill-icon-box">{SKILL_ICONS[skill.name] || <span>{skill.name[0]}</span>}</div>
...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'Webflow', level: '65%', desc: 'Professional low-code platform that enables designers to build high-end, responsive websites visually.' },
  ...
  const handleToggleSkills = (e) => {
    if (isExpanded) {
      // 1. Убираем фокус с кнопки, чтобы браузер не пытался скроллить к ней при изменении высоты
      if (e && e.currentTarget) {
        e.currentTarget.blur();
      }

      // 2. Сворачиваем список
      setIsExpanded(false);

      // 3. Скроллим к заголовку через макрозадачу, чтобы React успел начать анимацию сворачивания.
      // scrollIntoView гораздо надежнее window.scrollTo при изменении высоты DOM.
      setTimeout(() => {
  ...
  const experiences = [
    { company: 'Freelance', position: 'Developer & Designer', period: '2025-2026' },
    { company: 'SL SOFT', position: 'Senior UI/UX Designer', period: '2023-2024' },
    { company: 'М.Video-Eldorado', position: 'UX/UI Architect', period: '2022-2023' },
    { company: 'NDV', position: 'Lead Designer', period: '2021-2022' },
    { company: 'Domyland', position: 'Senior UI/UX Designer', period: '2020-2021' },
    { company: 'Cashoff', position: 'UX/UI Designer', period: '2016-2018' }
  ];
    ...
    <motion.div className="about-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <PageContainer>
          ...
          <div className="about-intro-grid">
            ...
            <div className="about-text-content">
              <div className="about-description">
                ...
                Привет, я Алексей.<br />
                Проектирую интерфейсы с фокусом на результат, переводя идеи в продукты сочетающие технологии и осмысленный, бесшовный пользовательский опыт. <br />
        ...
        <section className="skills-section">
          <div className="about-intro-grid"> 
            {/* Добавлен scrollMarginTop чтобы при скролле был отступ от навбара */}
            <div ref={skillsHeaderRef} style={{ scrollMarginTop: '100px' }}>
              <PageHeader 
                title="Hard Skills" 
                subtitle={<>Expertise shaped through experience,<br /> precision, and thoughtful design.</>} 
              />
            </div>

            <div className="skills-content-wrapper" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <section className="career-journey-section">
          <div className="career-section-header">
            <PageHeader title="Career Journey" subtitle="A progression of experiences, growth, and milestones." />
          </div>
