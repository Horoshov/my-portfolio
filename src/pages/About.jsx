          ...
          <div className="about-intro-grid">
            ...
            <div className="about-text-content">
              ...
              <div className="about-description">
                ...
                Привет, я Алексей.
                Создаю интерфейсы с фокусом на результат, превращая идеи в цифровые продукты сочетающие технологии и осмысленный пользовательский опыт. <br />
                ...
                <p className="description-body">
                <b>Product:</b> Веду проект от MVP до масштабирования, опираясь на метрики, бизнес-задачи и Data.
                </p>
                <p className="description-body">
