    ...
    <>
      <nav className="navbar">
        ...
        <div className="nav-col nav-col-menu">
          ...
          >
            ...
            <path d="M20.75 7C20.75 7.41421 20.4142 7.75 20 7.75H4C3.58579 7.75 3.25 7.41421 3.25 7C3.25 6.58579 3.58579 6.25 4 6.25H20C20.4142 6.25 20.75 6.58579 20.75 7Z" fill="currentColor"/>
            ...
            <path d="M20.75 17C20.75 17.4142 20.4142 17.75 20 17.75H4C3.58579 17.75 3.25 17.4142 3.25 17C3.25 16.5858 3.58579 16.25 4 16.25H20C20.4142 16.25 20.75 16.5858 20.75 17Z" fill="currentColor"/>
            </svg>
          </button>
        </div>
      </nav>
      ...
      <div className={`mobile-menu-overlay ${isMenuOpen ? 'active' : ''}`} onClick={closeMenu}>
        <div className="mobile-menu-content" onClick={(e) => e.stopPropagation()}>
          ...
          {/* Header Ñ Ð»Ð¾Ð³Ð¾Ñ‚Ð¸Ð¿Ð¾Ð¼ Ð¸ ÐºÑ€ÐµÑÑ‚Ð¸ÐºÐ¾Ð¼ */}
