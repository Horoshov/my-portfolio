    ...
    <header className="navbar-fixed">
      <div className="nav-container">
        ...
        <div className="nav-logo-wrapper">
          ...
          <path d="M45.84 5.29448C45.84 6.93939 44.885 8.20434 43.6113 8.75288V8.79513C44.9483 8.98511 45.6279 9.93383 45.6484 11.2202L45.7123 15.9013H42.6136L42.5503 11.7264C42.5292 10.7985 41.9767 10.2292 40.8735 10.2292H35.7154V15.9013H32.6172V1.09875H41.1705C43.9728 1.09875 45.84 2.51143 45.84 5.29504V5.29448ZM42.7196 5.7167C42.7196 4.45169 42.0406 3.75554 40.7674 3.75554H35.7154V7.67728H40.809C41.9761 7.67728 42.7196 6.98165 42.7196 5.71613V5.7167Z" fill="black"/>
          <path d="M55.2532 0.864746C59.8928 0.864746 62.8253 3.83036 62.8253 8.479C62.8253 13.1276 59.767 16.1353 55.1268 16.1353C50.4867 16.1353 47.5547 13.1276 47.5547 8.479C47.5547 3.83036 50.613 0.864746 55.2532 0.864746ZM59.6401 8.49979C59.6401 5.38682 57.8259 3.55706 55.1891 3.55706C52.5529 3.55706 50.7388 5.38682 50.7388 8.49979C50.7388 11.6127 52.5529 13.4425 55.1891 13.4425C57.8259 13.4425 59.6401 11.6127 59.6401 8.49979Z" fill="black"/>
          <path d="M0.527344 15.7257V1.15723H3.59241V6.85019H10.5752V1.15723H13.6331V15.7257H10.5752V9.38972H3.59241V15.7257H0.527344Z" fill="black"/>
          <path d="M23.3313 0.864746C27.9709 0.864746 30.9034 3.83036 30.9034 8.479C30.9034 13.1276 27.8451 16.1353 23.2049 16.1353C18.5648 16.1353 15.6328 13.1276 15.6328 8.479C15.6328 3.83036 18.6911 0.864746 23.3313 0.864746ZM27.7182 8.49979C27.7182 5.38682 25.9041 3.55706 23.2673 3.55706C20.631 3.55706 18.8169 5.38682 18.8169 8.49979C18.8169 11.6127 20.631 13.4425 23.2673 13.4425C25.9041 13.4425 27.7182 11.6127 27.7182 8.49979Z" fill="black"/>
          <path d="M80.0898 15.7257V1.15723H83.1549V6.85019H90.1377V1.15723H93.1956V15.7257H90.1377V9.38972H83.1549V15.7257H80.0898Z" fill="black"/>
          </svg>
