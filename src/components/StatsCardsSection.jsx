  ...
  const cards = [
    {
      ...
      gridArea: '1 / 1 / 7 / 9',
      bgColor: '#D6F0FF',
      title: 'Использование <b>Ai tools</b> пушит процессы и дает прирост производительности',
      value: '5x',
      layout: 'top-group', 
      iconType: 'cube',
      iconBg: '#8BD3FF',
    ...
    },
    {
      ...
      gridArea: '1 / 16 / 6 / 25',
      bgColor: '#F5F0EB',
      title: 'Оптимизированные решения на уровне кода, плюс к Performance',
      value: 'kWh',
      layout: 'spread',
      iconType: 'layout',
      iconBg: '#FFFFFF',
    ...
    },
    {
      ...
      gridArea: '7 / 1 / 11 / 9',
      bgColor: '#F8F8F8',
      title: 'Синхронизация с ядром продукта',
      value: '100%',
      layout: 'spread',
      iconType: 'layout',
      iconBg: '#FFD4A8',
    ...
    },
    {
      ...
      gridArea: '6 / 17 / 11 / 25',
      bgColor: '#F8F8F8',
      title: 'Консистентная UX/UI архитектура не просто набор экранов, а прямая трансляция бизнес-логики в визуальный слой',
      value: '$',
