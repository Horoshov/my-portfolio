...
// Общий шаблон для текстовых страниц (Projects, Services и т.д.)
    ...
    <div className="about-stats-grid">
      <div className="stat-card">
        ...
        <div className="stat-label-group">
          ...
          <span className="stat-desc">of Experience</span>
        </div>
      </div>
      <div className="stat-card">
        <span className="stat-number">98</span>
        <div className="stat-label-group">
          <span className="stat-unit">Percent</span>
      ...
      <div className="stat-card">
        ...
        <div className="stat-label-group">
          ...
          <span className="stat-desc">Completed Successfully</span>
        </div>
      </div>
    </div>
  </motion.section>
  ...
  return (
    <Router>
      <div className="app-container">
        ...
        {/* SVG Маска для формы цветка (Four-Leaf Clover) */}
        <svg width="0" height="0" style={{ position: 'absolute' }}>
          <defs>
            <clipPath id="flower-clip" clipPathUnits="objectBoundingBox">
              <path d="M0.5,0.5 C0.5,0.224,0.724,0,1,0 C1,0.276,0.776,0.5,0.5,0.5 C0.776,0.5,1,0.724,1,1 C0.724,1,0.5,0.776,0.5,0.5 C0.5,0.776,0.276,1,0,1 C0,0.724,0.224,0.5,0.5,0.5 C0.224,0.5,0,0.276,0,0 C0.276,0,0.5,0.224,0.5,0.5 Z" />
            </clipPath>
          </defs>
        </svg>
      </div>
