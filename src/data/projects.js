export const allProjects = [
    {
      ...
      year: '2024',
      description: 'Coincom — Проектирование и развитие UX/UI финтех-платформы',
      descriptionSecondary: "Работа над интерфейсами федеральной сети терминалов самообслуживания. В основе проекта — трансформация бизнес-задач в интуитивные пользовательские сценарии и создание высокодетализированных интерактивных прототипов. Процесс включал валидацию продуктовых гипотез, защиту дизайн-решений перед стейкхолдерами и авторский надзор на всех этапах интеграции в Hardware-среду.",
      timeline: '4 Months',
      location: 'Dubai, UAE',
